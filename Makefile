...
OBJ_FILES = GFq.o Report.o Utils_2.o LDPC_1.o LDPC_2.o Encoding.o Main.o
H_FILES = Functions.h Utils_2.h LDPC_1.h LDPC_2.h Encoding.h Portability.h Channel.h Report.h Definitions.h GFq.h
